...
- Initialized the open-source rebuild workspace
- Added Fastify + WebSocket API foundation
- Added MongoDB-backed project, session, message, and run models
- Added first-pass React workspace UI
- Added product, testing, roadmap, backlog, API, and data model docs
- Added open-source governance and CI baseline
- Added file tree and basic text editor workspace
- Added browser terminal workspace backed by `node-pty`
- Added read-only Git status and diff workspace
...
- Added WebSocket reconnect handling with automatic re-subscription and workspace refresh
